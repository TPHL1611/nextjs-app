            ...
            <div className="flex flex-wrap max-w-[500px] gap-x-4 gap-y-6 px-4 md:px-0">
                ...
                {homeData.map((data) => (
                    <Link
                        href={`/${data.url}`}
                        key={data.id}
                        className="rounded-xl border border-white-800 px-3 text-sm py-4 md:py-5 text-center w-full md:w-[48%] shadow-md shadow-[#ffffff1c] hover:shadow-lg hover:shadow-[#ffffff3d] duration-500 hover:-translate-y-1">
